...
public class JdNuevaCompra extends javax.swing.JDialog {
    ...
    private void initicializar() {
        ...
        LinkedList<Producto> lstProducto = nProducto.listar();
    ...
    private void recargarComboProducto(LinkedList<Producto> fuenteDatos) {
        if (fuenteDatos != null) {
    ...
    public JdNuevaCompra(JDialog owner, boolean modal) {
        super(owner, modal);
        initComponents();
        initicializar();
    }

    public ArrayList<Object[]> obtenerDatoTablaTemporalCompra() {
    ...
    private void btnGuardarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnGuardarMousePressed
        ...
        ArrayList<Object[]> items = obtenerDatoTablaTemporalCompra();
        boolean exito = nCompra.nuevaCompra(nombre, date, items);
    ...
    private void btnAgregarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAgregarMousePressed
        ...
        float precioReferencia = (Float) producto.getPrecioreferencia();
    ...
    private void cmbProductoItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbProductoItemStateChanged
        ...
        if (p != null) {
            ...
            float precio = p.getPrecioreferencia();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JdNuevaCompra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JdNuevaCompra().setVisible(true);
            }
        });
    }
