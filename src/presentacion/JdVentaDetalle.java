...
public class JdVentaDetalle extends javax.swing.JDialog {
     ...
     */
    public JdVentaDetalle(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JdVentaDetalle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JdVentaDetalle dialog = new JdVentaDetalle(new javax.swing.JDialog(), true);
    ...
    private void listarVentadetalle(JTable tabla) {
        ...
        if (listdetalleventa != null) {
            for (int i = 0; i < listdetalleventa.size(); i++) {
                ...
                producto = (Producto) nproducto.obtener(detalleventa.getProducto().getId());
                Object[] datos = {
                    detalleventa.getId(),
                    producto.getNombre(),
