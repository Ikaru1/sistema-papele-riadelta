...
public class JdRegistroCliente extends javax.swing.JDialog {
     ...
     */
    public JdRegistroCliente(java.awt.Dialog parent, boolean modal, int tipo) {
        super(parent, modal);
        initComponents();
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        clienteDAO.agregar(nombre, nit, telefono);
        this.dispose();
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        if (txtCodigo.isEnabled()) {
            ...
            clienteBqd = clienteDAO.obtener(codigo);
        } else if (txtNombre.isEnabled()) {
            String nombre = txtNombre.getText().trim().toUpperCase();
            clienteBqd = clienteDAO.obtener(nombre);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JdRegistroCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                JdRegistroCliente dialog = new JdRegistroCliente(new javax.swing.JDialog(), true, 0);
    ...
    public void codigoSiguiente() {
        String codigo = clienteDAO.codigoSiguiente() + "";
